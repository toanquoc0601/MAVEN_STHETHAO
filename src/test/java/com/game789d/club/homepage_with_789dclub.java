...
public class homepage_with_789dclub extends AbstractTest {
	...
	public void beforeClass(String browserName) {
		...
		driver.get("https://prod20091.bti.bet/vi/sports?operatorToken=14-7b31bd257e1ae433d2d90fee42413cff");
	}
	...
	public void TC_05_Check_History_Bet_And_Cancel() {
		...
		homepage.clickToDropdownTimeSelect();
		
		//Click chọn Dropdown "3 tháng qua"
		log.info("TC_05_Check_History_Bet_And_Cancel - Step 07: Click to dropdown '3 tháng qua'");
		homepage.clickToDropdownTimeSelect();
		//Click button Close "X"
		log.info("TC_05_Check_History_Bet_And_Cancel - Step 08: Click to 'X'");
		homepage.clickToCloseButton();
	}
	@Test
	public void TC_06_Check_Slant_Bet() {
		...
		log.info("TC_06_Check_History_Bet_And_Cancel - Step 06: Click to 'Cược thêm'");
	}
